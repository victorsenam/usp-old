...
public class Card { 
    ...
    private int rank;      // deuce = 0, three = 1, four = 2, ..., ace = 12
   ...
   public static void main(String[] args) { 
      ...
      // draw dealer's cards
      Card c1 = new Card(27, "cards/27.gif", "cards/back.gif");
      c1.drawBack(100, 120);
      Card c2 = new Card(51, "cards/51.gif", "cards/back.gif");
      c2.drawFront(100, 60);
      System.out.println(c1 + ", " + c2);

      // draw player's cards
      Card c3 = new Card(23, "cards/23.gif", "cards/back.gif");
      c3.drawFront(300, 120);
      Card c4 = new Card(30, "cards/30.gif", "cards/back.gif");
      c4.drawFront(300, 60);
