...
public final class In {
    ...
    /* ************************************************************* */ 
    /* ************* CASO O MONITOR QUEIRA MEXER: ****************** */
    /* ************************************************************* */  

    private final int conTime = 2; // Connection max time in secs
    private final int readTime = 15; // Read max time in secs
   ...
   /**
    ...
    public In(String name) {
        ...
        try {
	     ...
	     site.setConnectTimeout(conTime* 1000);
	     site.setReadTimeout(readTime * 1000);
