...
Este é um relatório sobre a implementação do método dos Gradientes Conjugados para encontrar um $x \in \mathbb{R}^n$ tal que $Ax = b$ onde $A \in \mathbb{R}^{n \times n}$ é esparsa, positiva definida e conhecida e $b \in \mathbb{R}^n$.
