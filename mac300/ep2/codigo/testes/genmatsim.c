...
// com matriz de coeficientes simetrica e solucao x tal que 
// x_i = 1+i%(n/100), i=0, ..., n-1.
...
int main()
{
  ...
  // Calcula a matriz simetrica A = M^T M (veja a implementacao
  // do produto M^T M orientada a linha).
