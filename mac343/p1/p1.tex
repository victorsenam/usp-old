...
\item existe $x \in R_+^n$ tal que $Ax = 0$ e $x \neq 0$;
\item existe $y \in R^m$ tal que $A^Ty < 0$.
\end{enumerate}

\begin{proof}[Resposta]
Queremos provar que vale tanto $(i)$ quanto $(ii)$. Para provar isso, vamos considerar um PL e seu dual.  
...
Vamos provar, primeiro que vale pelo menos um dos dois.  
\end{proof}
